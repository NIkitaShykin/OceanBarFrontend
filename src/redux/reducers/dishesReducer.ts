...
const initialState: dishesType = [
  {
    ...
    "ingredients": [{ name: "краб опилио (фаланги)", isAdded: true }, { name: "моллюски: морские черенки, вонголе, мидии", isAdded: true }, { name: "лук", isAdded: true }, { name: "чеснок", isAdded: true }],
    "dishCategory": "Плато"
  },
  {
    "id": 2,
