const foodData = [
    [
        {
            ...
            ingredients: ["авокадо — 2 шт.","зелень — для подачи","лук-шалот — 1 головка","оливковое масло — 1,5 ст. л","лимон — 0,5 шт"]
        },
        {
            id: 2,
            name: 'Тунец',
            ...
            ingredients: ["кунжут — 30 г","белок — 1 шт","соль, смесь перцев — по вкусу","оливковое масло — 2 ст. л."]
        },
        {
            id: 3,
            name: 'Мидии',
        ...
        },
        {
            ...
            ingredients: ["петрушка — 3–4 веточки","белый лук — 1 головка","виски (ром, коньяк) — 3 ст. л","рисовая мука — 2 ч. л.","сливки 33 % — 150 мл"]
        },
        {
            id: 5,
            name: 'Магуро',
            ...
            ingredients: ["ракушки — 6–7 штук","креветки - 100г","коньяк — 2 ст. л","соус— 1 ч. л."]
        }
    ],
    [
        {
            ...
            ingredients: ["Филе-кальмара — 2 шт.","рисом-сушидзу","артишок — 1 головка","оливковое масло — 1,5 ст. л","лимон — 0,5 шт"]
        },
        {
            id: 2,
            name: 'Лосось из печи',
            ...
            ingredients: ["филе лосося","огурец — по вкусу","деревенская сметана — 2 ст. л."]
        },
        {
            id: 3,
            name: 'Сибас на гриле',
            ...
            ingredients: ["соусом из оливок","каперсами–3 капли","лук-шалот — 1 головка","мясистый томат — 2 шт."]
        },
        {
            id: 4,
            ...
            ingredients: ["белый лук — 1 головка","ром со вкусом дыма — 1 ст. л","рисовая мука — 2 ч. л.","сливки 33 % — 150 мл"]
        },
        {
            id: 5,
            ...
            ingredients: ["креветки - 100г","соус красный — 2 ст. л","соус— 1 ч. л."]
        }
    ...
    [
        ...
        },
        {
            ...
            ingredients: ["яблочно-клюквенным соусом — 30 г","белок — 1 шт","соль, смесь перцев — по вкусу","оливковое масло — 2 ст. л."]
        },
        {
            id: 3,
            name: 'КАРТОШКА',
            ...
            ingredients: ["чеснок — 2шт","соус табаско — 2–3 капли","сметана -1 ложка","лук-шалот — 1 головка","мясистый томат — 2 шт."]
        },
        {
            id: 4,
            name: 'ХУМУС  ',
            ...
            ingredients: ["жареным нутом — 3шт","соус табаско — 2–3 капли","сметана -1 ложка","лук-шалот — 1 головка","мясистый томат — 2 шт."]
        },
        {
            id: 5,
            name: 'БОРЩ',
            ...
            ingredients: ["пампушки — 5шт","белой фасоли — 3 шт","сметана -1 ложка","лук-шалот — 1 головка","мясистый томат — 2 шт."]
        }
        ,
        {
            id: 6,
            ...
            ingredients: ["тахийной пасты — 3ложки","тмин 3 ложки","лук-шалот — 1 головка","мясистый томат — 2 шт."]
        }
        ,
        {
            id: 7,
            ...
            ingredients: ["корнишоны","соус маринованный в меду — 2–3 капли","болгарский перец","лук-шалот — 1 головка","мясистый томат — 2 шт."]
        }
        ,
        {
            id: 8,
