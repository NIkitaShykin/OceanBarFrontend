...
const foodData = [
  [
    ...
    },
    {
      ...
      ingredients: {петрушка:true, соус:false, чеснок:true, шалот:true,томат:true}
    },
    {
      id: 4,
      name: 'Креветки',
  ...
  [
    ...
    },
    {
      ...
      ingredients: {чеснок:true, морковь:true, чеснок:true, капуста:true}
    }
  ],
  [
    {
      ...
      ingredients: {кальмар:true, сушидзу:true, артишок:true, масло:true, лимон:true}
    },
    {
      id: 2,
      name: 'Лосось из печи',
    ...
    },
    {
      ...
      ingredients: {креветки:true, соус:true, соус:true}
    }
  ...
  [
    {
      ...
      ingredients: {авокадо:true, зелень:true, шалот:true, масло:true, лимон:true}
    },
    {
      id: 2,
      name: 'ЛАТКЕС ',
    ...
    },
    {
      ...
      ingredients: {чеснок:true, соус:true, cметана:true, лук:true, томат:true}
    },
    {
      id: 4,
      name: 'ХУМУС  ',
    ...
    },
    {
      ...
      weight: '250г',
      image: 'https://dellos-delivery.ru/upload/resize_cache/iblock/6db/1000_1000_0/6db539b51c19ae13921090e7040b8b81.jpg',
      ingredients: {пампушки:true, фасоль:true, сметана:true, рис:true, томат:true}
    },
    {
      id: 6,
      name: 'ПИТА',
    ...
    },
    {
      ...
      ingredients: {селёдка:true, яйца:true, сыр:true, чедер:true, зёрна:true}
    }
  ],
  [
    {
    ...
    },
    {
      ...
      weight: '450г',
      image: 'https://www.edimdoma.ru/system/images/contents/0000/6789/wide/AdobeStock_196463507_result.jpeg?1564134469',
      ingredients: {петрушка:true, соус:true, чеснок:true, лук:true, томат:true}
    },
    {
      id: 4,
      name: 'Стейк из лосося',
