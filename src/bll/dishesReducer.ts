...
export const dishesReducer = (state = initialState, action: any): dishesDataType => {
...
export const updateDishesAC = (addedDish: any): any => { return { type: "addDishes", addedDish} };

// thunks-------------------------------------------------------------------
// export const getDishesFromApiTC  = () => (dispatch: Dispatch<any>) => {
    // alert("gfgfg")
//      API.logoutUser()
//         .then(res => {
...
//         dispatch(updateDishesAC(false, res))
//     })
// } 

// export const getDishesFromApiTC = () => async (dispatch: Dispatch): Promise<void> => {
//     setTimeout(() => dispatch(updateDishesAC("fdgf")), 1000);
//   };
...
// export const getDishesFromApiTC = (email: string) => {

//     return (dispatch: Dispatch) => {

//         alert("gdfg")

//         // API.getAllDish(email)
//         //     .then((res) => {
//         //         dispatch(updateDishesAC(res.data))
               
//         //     })
//         //     .catch((rej) => {
               
//         //               dispatch(updateDishesAC(false))
